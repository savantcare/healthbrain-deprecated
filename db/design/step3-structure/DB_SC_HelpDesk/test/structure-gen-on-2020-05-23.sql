...
/*!50001 VIEW `test` AS select 1 AS `ticketId`,1 AS `title`,1 AS `comment`,1 AS `created_at`,1 AS `fullname`,1 AS `status`,1 AS `updated_at`,1 AS `typeId`,1 AS `userId`,1 AS `assignedId` */;
