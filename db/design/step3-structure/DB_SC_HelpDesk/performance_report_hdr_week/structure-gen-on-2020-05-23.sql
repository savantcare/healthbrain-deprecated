...
/*!50001 CREATE TABLE `performance_report_hdr_week` (
...
/*!50001 DROP TABLE IF EXISTS `performance_report_hdr_week`*/;
/*!50001 DROP VIEW IF EXISTS `performance_report_hdr_week`*/;
...
/*!50001 VIEW `performance_report_hdr_week` AS select 1 AS `user_id`,1 AS `role`,1 AS `Fullname`,1 AS `total`,1 AS `resolved`,1 AS `reopen`,1 AS `avg_response`,1 AS `avg_resolution_time_in_min`,1 AS `avg_response_time_in_min` */;
