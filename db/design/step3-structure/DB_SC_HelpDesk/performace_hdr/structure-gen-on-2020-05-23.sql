...
/*!50001 CREATE TABLE `performace_hdr` (
...
/*!50001 DROP TABLE IF EXISTS `performace_hdr`*/;
/*!50001 DROP VIEW IF EXISTS `performace_hdr`*/;
...
/*!50001 VIEW `performace_hdr` AS select 1 AS `user_id`,1 AS `total`,1 AS `resolved`,1 AS `reopen`,1 AS `avg_response` */;
