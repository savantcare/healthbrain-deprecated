...
/*!50001 VIEW `breakup_performance_report_for_year` AS select 1 AS `assignedId`,1 AS `userId`,1 AS `id`,1 AS `open_time`,1 AS `response_time`,1 AS `response_duration`,1 AS `closed_time`,1 AS `resolution_duration`,1 AS `response` */;
