...
CREATE TABLE `currentMartialStatus` (
  ...
  `recordChangedByUID` int(11) unsigned DEFAULT NULL,
  `recordChangedOnDateTime` datetime DEFAULT current_timestamp(),
  `recordChangedOnTimeZone` varchar(255) DEFAULT NULL,
