...
CREATE TABLE `remUserDefaultSettings` (
  ...
  `defaultHosts` text DEFAULT NULL,
  `defaultAssets` text DEFAULT NULL,
  ...
  `durationComboForInitialConsultation` text DEFAULT NULL,
  `durationComboForFollowup` text DEFAULT NULL,
  ...
  `provides` text DEFAULT NULL COMMENT 'This will contain a serialized array for facilities provided by provider like Therapy or Medication etc.',
  `supportedLanguages` text DEFAULT NULL COMMENT 'This will contain a serialised array of the language list that the provider supports',
  `messageForPatient` text DEFAULT NULL COMMENT 'If the doctor has filled out a message when “Request initial consultation is clicked” show this message to the user and they must click on “I agree” to go the next page',
