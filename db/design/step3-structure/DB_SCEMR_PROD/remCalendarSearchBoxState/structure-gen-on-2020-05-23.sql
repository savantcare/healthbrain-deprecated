...
CREATE TABLE `remCalendarSearchBoxState` (
  ...
  `lastViewedAttendeesInfo` text DEFAULT NULL COMMENT 'This field holds the color code and patient hours for the attendees selected in calendar search box',
  `userSpecificCalendarSettings` text DEFAULT NULL,
