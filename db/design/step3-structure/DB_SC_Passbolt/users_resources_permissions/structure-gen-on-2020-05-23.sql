...
/*!50001 CREATE TABLE `users_resources_permissions` (
...
/*!50001 DROP TABLE IF EXISTS `users_resources_permissions`*/;
/*!50001 DROP VIEW IF EXISTS `users_resources_permissions`*/;
