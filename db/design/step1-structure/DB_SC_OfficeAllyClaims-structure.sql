...
--
-- Current Database: `DB_SC_OfficeAllyClaims`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `DB_SC_OfficeAllyClaims` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `claimsUsingOfficeAllyDataFromFileEDI` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=99043 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
CREATE TABLE `claimsUsingOfficeAllyDataFromFileERA` (
  ...
  `fileReadeTimeZone` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=48924 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `claimsUsingOfficeAllyDataFromFileHCFA` (
  ...
  `fileReadeTimeZone` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=56225 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=83213 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=43451 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
