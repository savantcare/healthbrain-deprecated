...
CREATE TABLE `patientsMedicationOrder` (
  ...
  `autoHdr` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Auto HDR created for medication consent',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=53833 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `patientsMedicationOrder_bk-17Jan2020` (
  ...
  `autoHdr` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Auto HDR created for medication consent',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=52781 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
