...
CREATE TABLE `helpdeskActivityLog` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=221267 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `helpdeskCommentDocuments` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1201 DEFAULT CHARSET=utf8 COMMENT='1. One upload ID can have multiple documents 2. File content is stored in the documents table since we do not want the app to depend on the file system.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `helpdeskDocuments` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15277 DEFAULT CHARSET=utf8 COMMENT='1. One upload ID can have multiple documents 2. File content is stored in the documents table since we do not want the app to depend on the file system.';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
) ENGINE=InnoDB AUTO_INCREMENT=718 DEFAULT CHARSET=utf8 COMMENT='1. Documents are put in this table temporarily. Once we get the upload id than we move the documents to the documents table. 2. When the documents are uploaded the uploadID is still not available. The uploadID only becomes available when the user hits the "Save" button. Hence we need this temp table.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=14415 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `mailSentDetails` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=73982 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `userHelpdesk` (
  ...
  KEY `source` (`sourceId`),
  KEY `type` (`typeId`),
  CONSTRAINT `priority` FOREIGN KEY (`priority`) REFERENCES `userHelpdeskPriorityMaster` (`id`),
  CONSTRAINT `source` FOREIGN KEY (`sourceId`) REFERENCES `helpdeskSourceMaster` (`id`),
  CONSTRAINT `statusId` FOREIGN KEY (`statusId`) REFERENCES `userHelpdeskStatusMaster` (`id`),
  CONSTRAINT `type` FOREIGN KEY (`typeId`) REFERENCES `userHelpdeskTypeMaster` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=66058 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
CREATE TABLE `userHelpdeskComment` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=48263 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
