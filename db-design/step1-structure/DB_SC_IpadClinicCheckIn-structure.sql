...
--
-- Current Database: `DB_SC_IpadClinicCheckIn`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `DB_SC_IpadClinicCheckIn` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `ipadDetails` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=latin1 COMMENT='all iPad details which have check-in ios app installed';
