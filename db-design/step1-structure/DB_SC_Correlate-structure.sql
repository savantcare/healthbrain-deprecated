...
CREATE TABLE `correlatedMeasurementOfPatient` (
  ...
  CONSTRAINT `correlatedMeasurementOfPatient_ibfk_2` FOREIGN KEY (`uid`) REFERENCES `DB_SCEMR_PROD`.`users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `correlatedMeasurementOfPatient_ibfk_3` FOREIGN KEY (`uidOfPatient`) REFERENCES `DB_SCEMR_PROD`.`users` (`id`)
