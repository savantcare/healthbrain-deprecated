...
CREATE TABLE `assignedDetails` (
  ...
  CONSTRAINT `assignedDetails_ibfk_2` FOREIGN KEY (`patientId`) REFERENCES `DB_SCEMR_PROD`.`users` (`id`),
  CONSTRAINT `assignedDetails_ibfk_3` FOREIGN KEY (`assignedByID`) REFERENCES `DB_SCEMR_PROD`.`users` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2979 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
CREATE TABLE `driveFileTags` (
  ...
  CONSTRAINT `driveFileTags_ibfk_2` FOREIGN KEY (`uidOfCreatedBy`) REFERENCES `DB_SCEMR_PROD`.`users` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13059 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=22260 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `driveFilesViewer` (
  ...
  CONSTRAINT `driveFilesViewer_ibfk_1` FOREIGN KEY (`uidOfViewedBy`) REFERENCES `DB_SCEMR_PROD`.`users` (`id`),
...
CREATE TABLE `fileDownloadMaster` (
  ...
  CONSTRAINT `fileDownloadMaster_ibfk_1` FOREIGN KEY (`uidOfDownloadedBy`) REFERENCES `DB_SCEMR_PROD`.`users` (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=1995 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
