...
CREATE TABLE `cronCreatedForCacheUsedBySmartBarAgentToDisplayRequiredData` (
  ...
  `smartbar_current_status_id` smallint(6) NOT NULL DEFAULT '0',
  `smartbar_last_status_updated_by_uid` int(11) DEFAULT NULL,
  `smartbar_last_status_update_date_time` datetime DEFAULT NULL,
  `smartbar_last_status_update_time_zone` varchar(50) DEFAULT NULL,
...
--
-- Table structure for table `monitoringSmartbarStatusMaster`
--

DROP TABLE IF EXISTS `monitoringSmartbarStatusMaster`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `monitoringSmartbarStatusMaster` (
...
--
-- Table structure for table `patientMonitoringSmartbarStatusDetails`
--

DROP TABLE IF EXISTS `patientMonitoringSmartbarStatusDetails`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `patientMonitoringSmartbarStatusDetails` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `patientID` int(11) NOT NULL,
  `frequencyID` int(11) NOT NULL,
  `conditionID` int(11) NOT NULL,
  ...
  `createdBy` int(11) NOT NULL,
  `createdOn` datetime NOT NULL,
  `createdOnTimeZone` varchar(50) NOT NULL,
  PRIMARY KEY (`id`)
